...
class Ui_analyse_Window(object):
    ...
    def retranslateUi(self, analyse_Window):
        ...
        self.data_show_comboBox.setItemText(4, QCoreApplication.translate("analyse_Window", u"Phase difference diagram", None))
        self.data_show_comboBox.setItemText(5, QCoreApplication.translate("analyse_Window", u"Angular velocity diagram", None))
        self.data_show_comboBox.setItemText(6, QCoreApplication.translate("analyse_Window", u"Torque diagram", None))
        self.data_show_comboBox.setItemText(7, QCoreApplication.translate("analyse_Window", u"Shear rate diagram", None))
        ...
        ___qtablewidgetitem5.setText(QCoreApplication.translate("analyse_Window", u"Angle of permanent magnet \u03a6_B / \u00b0", None))
        ___qtablewidgetitem6 = self.table_Widget.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("analyse_Window", u"Angle of permanent magnet  \u03a6_m / \u00b0", None))
        ___qtablewidgetitem7 = self.table_Widget.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("analyse_Window", u"Phase difference /  \u00b0", None))

...
class Ui_Title(object):
    def setupUi(self, Title):
        ...
        self.widget.setGeometry(QtCore.QRect(330, 10, 1411, 1011))
        ...
        self.k_b_label = QtWidgets.QLabel(self.widget)
        self.k_b_label.setObjectName("k_b_label")
        self.gridLayout_5.addWidget(self.k_b_label, 2, 0, 1, 3)
        self.select_mode_comboBox = QtWidgets.QComboBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.filter_checkbox = QtWidgets.QCheckBox(self.widget)
        ...
        self.label_sample_frequency.setGeometry(QtCore.QRect(20, 919, 198, 25))
        ...
        self.textbox_sample_frequency.setGeometry(QtCore.QRect(20, 950, 161, 21))
        self.textbox_sample_frequency.setToolTip("")
        self.textbox_sample_frequency.setObjectName("textbox_sample_frequency")
        self.widget1 = QtWidgets.QWidget(self.centralwidget)
        self.widget1.setGeometry(QtCore.QRect(13, 23, 291, 447))
        ...
        self.textbox_time = QtWidgets.QLineEdit(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setItalic(False)
        ...
        self.label_frequency = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setItalic(False)
        ...
        self.textbox_frequency = QtWidgets.QLineEdit(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setItalic(False)
        ...
        self.label_amplitude_1 = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setItalic(False)
        ...
        self.textbox_amplitude1 = QtWidgets.QLineEdit(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setItalic(False)
        ...
        self.textbox_offset1 = QtWidgets.QLineEdit(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setItalic(False)
        ...
        self.label_amplitude_2 = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setItalic(False)
        ...
        self.textbox_amplitude2 = QtWidgets.QLineEdit(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setItalic(False)
        ...
        self.textbox_offset2 = QtWidgets.QLineEdit(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setItalic(False)
        ...
        self.line_8 = QtWidgets.QFrame(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setItalic(False)
        ...
        self.label_direction = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setItalic(False)
        ...
        self.comboBox_direction = QtWidgets.QComboBox(self.widget1)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setItalic(False)
        ...
        self.widget2.setGeometry(QtCore.QRect(10, 476, 291, 151))
        ...
        self.button_send = QtWidgets.QPushButton(self.widget2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
...
"color: rgb(0, 0, 0);")
        ...
        self.button_stop = QtWidgets.QPushButton(self.widget2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
...
"color: rgb(0, 0, 0);")
        ...
        self.button_start = QtWidgets.QPushButton(self.widget2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
...
"color: rgb(0, 0, 0);")
        ...
        self.analyse_button = QtWidgets.QPushButton(self.widget2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setItalic(False)
...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout.addWidget(self.analyse_button, 1, 1, 1, 1)
        self.gridLayout_2.addLayout(self.gridLayout, 0, 0, 1, 1)
        self.save_button = QtWidgets.QPushButton(self.widget2)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setItalic(False)
        ...
        self.widget3.setGeometry(QtCore.QRect(18, 650, 302, 249))
        self.widget3.setObjectName("widget3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.widget3)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.status_label = QtWidgets.QLabel(self.widget3)
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.normalise_button = QtWidgets.QPushButton(self.widget3)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.button_cal_constant = QtWidgets.QPushButton(self.widget3)
...
"background-color: rgb(255, 170, 127);")
        ...
        self.gridLayout_3.addWidget(self.button_cal_constant, 6, 0, 1, 2)
        self.button_fr_constant = QtWidgets.QPushButton(self.widget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"background-color: rgb(255, 152, 222);")
        ...
        self.gridLayout_3.addWidget(self.button_fr_constant, 6, 2, 1, 1)
        self.graph_stop_button = QtWidgets.QPushButton(self.widget3)
        font = QtGui.QFont()
        font.setPointSize(9)
...
"background-color: rgb(255, 170, 0);")
        ...
        self.button_auto_range = QtWidgets.QPushButton(self.widget3)
        font = QtGui.QFont()
        font.setPointSize(9)
...
"background-color: rgb(255, 170, 0);")
        ...
        self.label_time_2 = QtWidgets.QLabel(self.widget3)
        font = QtGui.QFont()
        font.setFamily("Linux Libertine")
        ...
        self.timeInterval_comboBox = QtWidgets.QComboBox(self.widget3)
        font = QtGui.QFont()
        ...
        self.lcdNumber = QtWidgets.QLCDNumber(self.widget3)
        font = QtGui.QFont()
        font.setPointSize(9)
...
"border-color: rgb(255, 255, 127);")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1749, 26))

...
class Ui_analyse_Window(object):
    def setupUi(self, analyse_Window):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1524, 22))
    ...
    def retranslateUi(self, analyse_Window):
        ...
        self.data_show_comboBox.setItemText(6, _translate("analyse_Window", "Torque diagram"))
        self.data_show_comboBox.setItemText(7, _translate("analyse_Window", "Shear rate diagram"))
        self.data_show_comboBox.setItemText(8, _translate("analyse_Window", "Shear stress diagram"))
        self.data_show_comboBox.setItemText(9, _translate("analyse_Window", "Viscosity diagram"))
        ...
        item.setText(_translate("analyse_Window", "Angle of permanent magnet Φ_B / °"))
